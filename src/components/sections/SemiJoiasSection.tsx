...
import { AlertTriangle, FileText, Award, CheckCircle2, X, ZoomIn } from "lucide-react";
...
/* ── Imagem clicável ──────────────────────────────────────────────── */
function ZoomableImage({ src, alt, width = 400, height = 260 }: {
  ...
  return (
    <>
      <div
        className="relative rounded-xl overflow-hidden border border-black/5 cursor-zoom-in group"
      ...
      >
        ...
        >
          <div className="w-9 h-9 rounded-full flex items-center justify-center" style={{ backgroundColor: "rgba(3,54,36,0.7)" }}>
